...
CREATE TABLE `Cliente` (
    ...
    `senha` VARCHAR(191) NOT NULL DEFAULT 'senha123',
...
CREATE TABLE `Entrega` (
    ...
    INDEX `Entrega_fornecedor_id_fkey_1`(`fornecedor_id`),
    INDEX `Entrega_produto_id_fkey_1`(`produto_id`),
...
CREATE TABLE `ItemPedido` (
    ...
    INDEX `ItemPedido_pedido_id_fkey_1`(`pedido_id`),
    INDEX `ItemPedido_produto_id_fkey_1`(`produto_id`),
    PRIMARY KEY (`item_id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `MovimentoEstoque` (
    ...
    INDEX `MovimentoEstoque_produto_id_fkey_1`(`produto_id`),
...
CREATE TABLE `Pedido` (
    ...
    INDEX `Pedido_cliente_id_fkey_1`(`cliente_id`),
